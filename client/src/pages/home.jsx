        ...
        <>
            ...
            <main className="mt-48">                
                <div className="text-center">
                    <h2 className="text-6xl font-light">Get insights quickly, with MERN forms</h2>
                    <p className="mt-5 text-xl text-gray-600">Easily create and share online forms and surveys, and analyze responses in real-time.</p>
                </div>
                <div>
